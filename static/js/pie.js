function optionChanged(plot){
  ...
  if (plot === 'Race Percentages') {
    plotImage.html("<img src ='static/Images/pie_plots/race_pie.png'>")
    plotHeading.text('Race Percentages Pie Chart')
  }
  else if (plot === 'Fleeing') {
    plotImage.html("<img src ='static/Images/pie_plots/flee_pie.png'>")
    plotHeading.text('Fleeing Percentages Pie Chart')
  }
  else if (plot === 'Armed/Unarmed') {
    plotImage.html("<img src ='static/Images/pie_plots/armed_unarmed_pie.png'>")
    plotHeading.text('Armed or Unarmed Pie Chart')
  }
  else {
    plotImage.html("<img src ='static/Images/pie_plots/year_pie.png'>")
